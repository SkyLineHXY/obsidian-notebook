...
const OUT="D:/Desktop/研究生/国自然_地下空间多机器人SLAM/研究内容1框图_修订版.pptx";
...
// ---------------- Loop wires ----------------
// RIGHT gutter: bottom output → UP → top graph box (生成输入)
const outMidX=bx+wOut/2;
s.addShape(pres.shapes.LINE,{x:bx+wOut+0.04,y:bCY+bCH/2,w:RG-(bx+wOut+0.04),h:0,line:{color:TEAL,width:2.2}});
s.addShape(pres.shapes.LINE,{x:RG,y:bCY+bCH/2,w:0,h:-(bCY+bCH/2-(tCY+tCH/2)),line:{color:TEAL,width:2.2}});
s.addShape(pres.shapes.LINE,{x:RG,y:tCY+tCH/2,w:-(RG-(xGr+wGr+0.04)),h:0,line:{color:TEAL,width:2.2,endArrowType:"triangle"}});
txt(s,"生成输入\n𝓜 / x / P̄ / η",RG-0.55,(tCY+tCH/2+bCY+bCH/2)/2-0.3,1.1,0.62,{fs:8.2,color:TEAL_D,bold:true,lsm:1.1});

// LEFT gutter: top exec → DOWN → bottom sensor (闭环演化反馈)
s.addShape(pres.shapes.LINE,{x:xEx,y:tCY+tCH/2,w:-(xEx-LG),h:0,line:{color:ORANGE,width:2.4}});
s.addShape(pres.shapes.LINE,{x:LG,y:tCY+tCH/2,w:0,h:(bCY+bCH/2)-(tCY+tCH/2),line:{color:ORANGE,width:2.4}});
s.addShape(pres.shapes.LINE,{x:LG,y:bCY+bCH/2,w:(sx-LG),h:0,line:{color:ORANGE,width:2.4,endArrowType:"triangle"}});
txt(s,"闭环演化反馈\n执行→环境→新观测",LG-0.18,(tCY+tCH/2+bCY+bCH/2)/2-0.3,1.2,0.62,{fs:8.2,color:ORANGE_D,bold:true,lsm:1.1});
